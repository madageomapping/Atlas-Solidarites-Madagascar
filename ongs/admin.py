...
from models import mdgRegion, organisme, utilisateur, action, categorie, avancement, status 

class ActionAdmin(admin.ModelAdmin):
    fields = ['categories', 'titre', 'date', 'duree', 'description', 'region', 'localisation', 'illustration',  'responsable', 'avancement', 'organisme']
    list_display = ('get_categories', 'titre', 'organisme', 'date', 'duree', 'description', 'region', 'localisation', 'illustration', 'responsable', 'avancement', 'creation', 'maj')
    ...
    list_filter = ('categories', 'organisme', 'region', 'localisation', 'avancement')
    search_fields = ['titre', 'description', 'region', 'get_categories']
